...
WHITELIST_KEYWORDS = frozenset({
    ...
    "bar", "bartender", "bartending", "mixology", "mixologist",
    "recipe", "recipes", "ingredient", "ingredients",
    "spirit", "spirits", "liquor", "liqueur", "liqueurs",
    "gin", "vodka", "rum", "whiskey", "whisky", "bourbon", "tequila",
    "mezcal", "brandy", "cognac", "vermouth", "amaro", "aperitif",
    "digestif", "bitters", "syrup", "juice", "soda", "tonic",
    "wine", "beer", "champagne", "prosecco",
    # Techniques
    "shake", "shaken", "stir", "stirred", "muddle", "muddled",
    "strain", "strained", "build", "layer", "float", "rim",
    "garnish", "glassware", " coupe", "rocks", "highball",
    "martini", "old fashioned", "negroni", "manhattan",
    # Menu & business
    "menu", "menu design", "cocktail menu", "drink list",
    "pricing", "cost", "margin", "inventory", "stock",
    "bar management", "front of house", "service",
    # Flavor & chemistry
    "flavor", "flavour", "taste", "aroma", "palate", "finish",
    "balance", "sweet", "sour", "bitter", "umami", "salty",
    "citrus", "herbal", "floral", "spicy", "smoky", "fruity",
    "acid", "ph", "density", "viscosity", "layering",
    # Events & occasions
    "party", "wedding", "event", "tasting", "flight",
    "happy hour", "brunch", "dinner", "dessert",
})

BLACKLIST_KEYWORDS = frozenset({
    # Programming
    "python", "javascript", "java", "code", "coding", "program",
    "programming", "developer", "software", "app development",
    "debug", "compiler", "algorithm", "data structure",
    # Academic subjects
    "homework", "essay", "thesis", "dissertation", "exam",
    "math", "mathematics", "physics", "chemistry", "biology",
    "history", "geography", "literature", "philosophy",
    "quantum", "relativity", "calculus", "algebra",
    # General AI abuse
    "write a poem", "write a story", "write an essay",
    "solve this", "answer this question", "explain quantum",
    "explain relativity", "explain evolution",
    # Non-bartending professions
    "doctor", "lawyer", "engineer", "teacher", "accountant",
